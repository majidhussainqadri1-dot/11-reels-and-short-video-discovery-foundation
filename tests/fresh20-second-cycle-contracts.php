...
$markers = array(
	...
	array( 'future', 'public function can_private_user()' ),
	array( 'future', "empty( \$claims['is_suspended'] )" ),
	array( 'future', "! empty( \$claims['guardian_ok'] )" ),
	...
	array( 'hardening', 'translated-reel-current' ),
