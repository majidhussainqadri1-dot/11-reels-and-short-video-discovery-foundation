...
$must=array(
 ...
 ['admin','ORDER BY CASE reason_code'],['future',"'payment_or_donation_reason'=>false"],['future','medical_authority'],
);
foreach($must as [$k,$n])if(false===strpos($f[$k],$n)){fwrite(STDERR,"Missing current-plan marker [$k]: $n\n");exit(1);}
echo "RC8/Future30 governing-plan contracts PASS\n";
