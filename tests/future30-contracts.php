...
$must = array(
 ['bootstrap','Version: 1.2.0-rc4'], ['bootstrap',"define( 'RSV_CONTRACT_VERSION', 10 )"], ['bootstrap',"'class-rsv-future30.php'"], ['bootstrap',"'class-rsv-fresh20-hardening.php'"], ['bootstrap',"'class-rsv-fresh-review-hardening.php'"], ['bootstrap',"'class-rsv-third-review-hardening.php'"],
 ...
 ['future','rsv_translation_language_mismatch'], ['future','ReelQuizAttemptUpdated'], ['future','render_safe_tools'], ['future','ReelTranscriptProjectionReady'], ['future','ReelLanguageLinksReconciled'], ['future','authoritative_duration_seconds'], ['future','MIN_CREATOR_RESEARCH_SAMPLE'],
);
...
echo "File 11 Future30 rc4 contracts PASS\n";
