...
**Current repository candidate:** `1.2.0-rc2`  
...
## Future30 + fresh 20-round hardening

The 2026-08-12 Founder-approved amendment retains all `F11-FUT-001` through `F11-FUT-030` capabilities. The fresh 20-round corrective cycle additionally hardens Series/Learning Paths, evidence classification, remix/templates, peer-review conflict handling, 10-language linked-Reel truth, quiz attempts, public knowledge tools, private collections/notes, grounded AI context, recommendation explanations, feed preferences, Accessibility Plus and knowledge-graph read-time validation.

Full register: `docs/FRESH-20-REVIEW-REGISTER-1.2.0-rc2.md`.
...
- The original Reel language remains canonical and at most nine distinct current public linked Reel language versions may be attached.
...
bash tools/build-package.sh packages/reels-foundation-11-1.2.0-rc2.zip
```

The exact-head release workflow must pass PHP 8.1/8.3/8.4 suites, JavaScript syntax, inherited corrective regressions, Future30 + fresh20 contracts, deterministic double build, checksum, ZIP integrity and exact source/package parity.
