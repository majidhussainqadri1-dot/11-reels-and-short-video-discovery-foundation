...
grep -F "Version: 1.2.0-rc1" "$P/11-reels-foundation.php" >/dev/null
grep -F "define( 'RSV_VERSION', '1.2.0-rc1' )" "$P/11-reels-foundation.php" >/dev/null
grep -F "define( 'RSV_SCHEMA_VERSION', '1.2.0' )" "$P/11-reels-foundation.php" >/dev/null
grep -F "define( 'RSV_CONTRACT_VERSION', 7 )" "$P/11-reels-foundation.php" >/dev/null
...
echo "static contracts Future30 PASS"
