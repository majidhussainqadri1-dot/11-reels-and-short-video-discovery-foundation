...
foreach ( array(
	...
	'future_objects','future_edges','future_user_state',
) as $table ) {
	$wpdb->query( 'DROP TABLE IF EXISTS ' . $wpdb->prefix . 'rsv_' . $table ); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
}
foreach ( array(
	'rsv_schema_version','rsv_top20_schema_version','rsv_top20_rewrite_flush','rsv_future30_schema_version','rsv_future30_contract_version','rsv_future30_plan_revision','rsv_version','rsv_contract_version','rsv_page_map',
